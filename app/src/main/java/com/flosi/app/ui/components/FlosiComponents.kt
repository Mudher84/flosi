...
fun CardBox(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(containerColor = FlosiSurface),
...
fun ActionRow(
    ...
    Row(
        ...
        Box(
            modifier = Modifier
                .size(38.dp)
                .background(accent.copy(alpha = .11f), RoundedCornerShape(12.dp)),
        ...
        if (value != null) {
            Text(value, fontWeight = FontWeight.Bold, color = accent, fontSize = 13.sp)
        }
    }
}
...
fun moneyText(value: Long): String =
    "%,d د.ع".format(Locale.US, abs(value))

fun signedMoney(value: Long): String =
    (if (value >= 0) "+" else "−") + moneyText(value)
